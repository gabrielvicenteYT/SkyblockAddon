...
public class PlayerControllerMPHook {
    ...
    private static final Set<Location> DEEP_CAVERNS_LOCATIONS = EnumSet.of(Location.MINE, Location.GOLD_MINE,
            Location.LAPIS_MINE, Location.REDSTONE_MINE, Location.EMERALD_MINE, Location.DIAMOND_MINE, Location.OBSIDIAN_MINE);
    ...
    public static void onPlayerDamageBlock(BlockPos loc, ReturnValue<Boolean> returnValue) {
        ...
        if (heldItem != null) {
            ...
            if (main.getConfigValues().isEnabled(Feature.AVOID_BREAKING_STEMS) && (block.equals(Blocks.melon_stem) || block.equals(Blocks.pumpkin_stem))) {
                ...
                returnValue.cancel();
            } else if (main.getConfigValues().isEnabled(Feature.ONLY_MINE_VALUABLES_NETHER) && Location.NETHER.equals(main.getUtils().getLocation()) &&
