...
//        Set<Feature> features = tab.getFeatures();
        ...
        buttonList.add(new ButtonSocial(width / 2 + 200, 30, main, EnumUtils.Social.GITHUB));
...
//        tooltipFeature = null;
    ...
    private void addButton(Feature feature, EnumUtils.ButtonType buttonType) {
        ...
        if (buttonType == EnumUtils.ButtonType.TOGGLE) {
            ...
            if (credit != null && !main.getConfigValues().isRemoteDisabled(feature)) {
            ...
            if (feature.getSettings().size() > 0 && !main.getConfigValues().isRemoteDisabled(feature)) {
    ...
    private void addLanguageButton() {
        ...
        buttonList.add(new ButtonNormal(x, y, boxWidth, boxHeight, "Língua: " + Feature.LANGUAGE.getMessage(), main, Feature.LANGUAGE));
    }
