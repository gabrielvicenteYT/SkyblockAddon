...
public class ConfigValues {
    ...
    @Getter @Setter private Language language = Language.PORTUGUESE_BRAZIL;
    ...
    @Getter @SuppressWarnings("deprecation") private Set<Feature> remoteDisabledFeatures = EnumSet.of(
            Feature.AVOID_BREAKING_BOTTOM_SUGAR_CANE,
            ...
            Feature.SHOW_MAGMA_TIMER_IN_OTHER_GAMES,
            Feature.DOUBLE_DROP_IN_OTHER_GAMES,
            Feature.SUMMONING_EYE_ALERT,
            Feature.ONLY_MINE_ORES_DEEP_CAVERNS,
            Feature.SLAYER_INDICATOR,
            Feature.SPECIAL_ZEALOT_ALERT,
            Feature.ONLY_MINE_VALUABLES_NETHER,
            Feature.ENABLE_MESSAGE_WHEN_MINING_DEEP_CAVERNS,
            Feature.HIDE_PET_HEALTH_BAR,
            Feature.POWER_ORB_STATUS_DISPLAY,
            Feature.ZEALOT_COUNTER,
            Feature.TICKER_CHARGES_DISPLAY,
            Feature.TAB_EFFECT_TIMERS,
