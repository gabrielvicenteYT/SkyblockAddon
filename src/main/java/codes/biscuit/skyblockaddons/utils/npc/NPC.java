...
enum NPC {
    ...
    // Farm (in Hub)
    ARTHUR("Arthur", 51.5, 71, -136.5, asList(Tag.PLAYER, Tag.INFO), singletonList(Location.RANCH)),
    FARMER("Farmer", -44.5, 72, -162.5, asList(Tag.PLAYER, Tag.QUEST_NPC), singletonList(Location.RANCH)),
    SHANIA("Shania", 48.5, 72, -159.5, asList(Tag.COW, Tag.QUEST_NPC), singletonList(Location.RANCH)),
    ...
    // The Barn
    FARMHAND("Farmhand", 144.5, 73, -240.5, asList(Tag.VILLAGER, Tag.QUEST_NPC), singletonList(Location.FARM)),
    ...
    // Gold Mine
    BLACKSMITH_2("Blacksmith", -39.5, 77, -299.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.MINE)),
    GOLD_FORGER("Gold Forger", -27.5, 74, -294.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.MERCHANT), singletonList(Location.MINE)),
    IRON_FORGER("Iron Forger", -1.5, 75, -307.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.MERCHANT), singletonList(Location.MINE)),
    RUSTY("Rusty", -20, 78, -326, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.MINE)),

    // Deep Caverns
    LIFT_OPERATOR_1("Lift Operator", 45.5, 150, 15.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.GOLD_MINE)),
    LIFT_OPERATOR_2("Lift Operator", 45.5, 121, 15.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.LAPIS_MINE)),
    LIFT_OPERATOR_3("Lift Operator", 45.5, 101, 15.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.REDSTONE_MINE)),
    LIFT_OPERATOR_4("Lift Operator", 45.5, 66, 15.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.EMERALD_MINE)),
    LIFT_OPERATOR_5("Lift Operator", 45.5, 38, 15.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.DIAMOND_MINE)),
    LIFT_OPERATOR_6("Lift Operator", 45.5, 13, 15.5, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.UTILITY), singletonList(Location.OBSIDIAN_MINE)),
    WALTER("", 19, 156, 36, asList(Tag.PLAYER, Tag.IMPORTANT, Tag.MERCHANT, Tag.BUY_ONLY), singletonList(Location.GOLD_MINE)),
