...
public class EnumUtils {
    ...
    public enum FeatureCredit {
        ...
        HENRY("Henry_Fabio", "github.com/HenryFabio",
                ...
                Feature.DISABLE_USELESS_MESSAGES,
                Feature.DISABLE_GLOBAL_CHAT
        );
    ...
    public enum UpdateMessageType {
        ...
        public String[] getMessages(String... variables) {
            String messageText;
            if (this == DEVELOPMENT) {
                messageText = "Você está utilizando um versão em desenvolvimento (" + SkyblockAddons.VERSION + "). Por favor, relate quaisquer bugs que ainda não foram encontrados. Obrigado.";
            } else {
    ...
    public enum Social {
        ...
        GITHUB(new ResourceLocation("skyblockaddons", "github.png"), "https://github.com/HenryFabio/SkyblockAddons");
    ...
    public enum ReforgeType {
        ...
        ARMOR_SMART("Inteligente"),
        HARMFUL("Nociva"),
        ARMOR_PURE("Pura"),
        ARMOR_CLEAN("Limpa"),
        ARMOR_TITANIC("Titânica"),
        ARMOR_FIERCE("Feroz"),
        ARMOR_LIGHT("Leve"),
        ARMOR_WISE("Sábia"),
        DIVINE("Divina"),
        KIND("Gentil"),
        ARMOR_MYTHICAL("Mítica"),
        DEMONIC("Demoníaca"),
        LEGENDARY("Lendária"),
        EPIC("Épica"),
        STRANGE("Estranha"),
        ...
        SPICY("Apimentada"),
        HEROIC("Heróica"),
        BOW_IMPOSING("Imponente"),
        BOW_FAST("Rápido"),
        BOW_ELEGANT("Elegante"),
        BOW_WEIRD("Estranho"),
        BOW_MORTAL("Mortal"),
        BOW_REFINED("Refinado"),
        BOW_RICH("Rico"),
        BOW_RUSHED("Apressado"),
        BOW_UNREAL("Irreal"),
        ACCESSORY_MANGY("Sarnento"),
        ACCESSORY_NICE("Agradável"),
        ACCESSORY_PRETTY("Bonito"),
        ACCESSORY_VIVID("Vívido"),
        ACCESSORY_BIZARRE("Bizarro"),
        ACCESSORY_SIMPLEW("Simples"),
        ACCESSORY_BRIGHT("Brilhante"),
        ACCESSORY_SINISTER("Sinistro"),
        ACCESSORY_WEIRD("Sinistro");
